...
intersected_2024 |>
    select(tract_area, intersect_area) |>
    head()
...
intersected_2024 |>
    select(tract_area, intersect_area, overlap_pct, votes_trump_2024, votes_dem_2024, total_votes_2024) |>
    head()
...
trump_shift |>
  select(geoid, trump_shift, trump_share_2024) |>
